  ...
  return (
    <div className="space-y-8 pb-8">
        ...
        <div className="relative w-full h-[400px]">
          ...
          <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center">
            ...
            <div className="space-x-4">
              <Link
                href="/marketplace"
                className="bg-gradient-to-br from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-white px-6 py-3 rounded-lg font-bold transition-all duration-200 inline-block"
              >
                Explore Marketplace
              </Link>
              <Link
      ...
      <section>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass rounded-lg p-6 border border-white/20 hover:border-cyan-400 transition-all duration-300">
            <h3 className="text-xl font-bold mb-2 text-cyan-400">Buy LAND Tokens</h3>
          ...
          <div className="glass rounded-lg p-6 border border-white/20 hover:border-cyan-400 transition-all duration-300">
            <h3 className="text-xl font-bold mb-2 text-purple-400">Acquire Parcels</h3>
            <p className="text-white/80">
          ...
          <div className="glass rounded-lg p-6 border border-white/20 hover:border-cyan-400 transition-all duration-300">
            <h3 className="text-xl font-bold mb-2 text-pink-400">Manage & Trade</h3>
            <p className="text-white/80">
      ...
      <section className="text-center py-12">
        <h2 className="text-4xl font-display font-bold mb-4 text-gradient-cyan-purple">Ready to Enter HyperLand?</h2>
